...
for seed in range(1, 6):
    ...
    count_missing = 0
    EMBED_DIM = 512 # embedding dim from GPT-3.5
    ...
    gears_model = GEARS(pert_data, device = device, 
                            ...
                            proj_name = 'New_gears', 
                            exp_name = f'geneformer_{data_name}_split{seed}')
    gears_model.model_initialize(hidden_size = 64)
    
    gears_model.train(epochs = 15, lr = 1e-3)

    model_save_path = f'/home/share/huadjyin/home/zhoumin3/zhoumin/model_benchmark/01_A_results/{data_name}/new_geneformer/split{seed}'
